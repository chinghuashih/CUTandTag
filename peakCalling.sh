...
# peak calling methods: SEACR, MACS2 or GoPeaks
peakCalling="SEACR"
...
# GoPeaks parameters
mdist=1000
# merging peaks if the distance between peaks (bp); default: 1000bp
pval=0.05
# significance threshold <pval> with multiplehypothesis correction via Benjamini-Hochberg. Default: 0.05
step=100
